...
function main() {
  ...
  ********************************/
   ...
   * DO NOT EDIT
  ********************************/
  var script_name = "Search Impression Share";
  ...
  while(campaignIterator.hasNext()) {
    ...
    while(keywordIterator.hasNext()) {
      ...
      if(stats_today.getAveragePosition() <= stats_yesterday * (1 - alert_threshold)){
        alert_body[i] = "Keyword: " + keyword.getText() + " | Match Type: " + keyword.getMatchType() + " went from position " + stats_yesterday.getAveragePosition() + " to position " + stats_today.getAveragePosition() + ". (Campaign: " + keyword.getCampaign() + " Ad Group: " + keyword.getAdGroup() + ")\n";
        i++;
      }
    }
  }
